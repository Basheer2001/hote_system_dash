...
class BanUnbanRepo extends GetxService {
  ...
  Future<AppResponse<Map<String, dynamic>>> banUser(int userId) async {
    return await _changeUserStatus(userId, 'ban');
  }

  Future<AppResponse<Map<String, dynamic>>> unbanUser(int userId) async {
    return await _changeUserStatus(userId, 'unban');
  }

  Future<AppResponse<Map<String, dynamic>>> _changeUserStatus(int userId, String action) async {
    try {
